...
export function EvidenceScreen({ images, checking, stage, checkError, onChange, onNext, onBack }: { images: LocalImage[]; checking: boolean; stage?: string; checkError?: string; onChange: (images: LocalImage[]) => void; onNext: () => void; onBack: () => void }) {
