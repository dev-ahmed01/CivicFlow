...
const styles = StyleSheet.create({
  ...
  categoryGrid: { flexDirection: "row", flexWrap: "wrap", gap: 11 }, categoryTile: { alignItems: "flex-start", borderRadius: 18, borderWidth: 1, flexGrow: 1, gap: 9, minHeight: 128, minWidth: 145, padding: 15, width: "47%" }, categoryTileNarrow: { minHeight: 92, width: "100%" }, categoryIcon: { alignItems: "center", borderRadius: 20, height: 40, justifyContent: "center", width: 40 }, categoryLabel: { flex: 1, fontSize: typeScale.body, fontWeight: fontWeights.semibold, lineHeight: 19 },
