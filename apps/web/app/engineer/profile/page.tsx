...
export default function EngineerProfilePage() {
  ...
  return <><header className="portal-heading"><div><p className="eyebrow">Account</p><h1>Engineer profile</h1><p>Your account is provisioned for your agency and assigned field work.</p></div></header><Card><dl className="detail-list"><div><dt>Email</dt><dd>{user?.email ?? "Unavailable"}</dd></div><div><dt>Role</dt><dd>Executive Engineer</dd></div><div><dt>Agency scope</dt><dd>{user?.agencyId ?? "Unavailable"}</dd></div></dl></Card></>;
}
