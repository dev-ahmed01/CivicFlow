...
export default function CitizenLoginPage() {
  ...
  const submit = async () => {
    ...
    try {
      ...
      const body = await response.json() as { accessToken?: string; demoMode?: boolean; error?: string };
      if (!response.ok) throw new Error(body.error ?? "Could not sign in");
      if (step === "phone") { setDemoMode(body.demoMode === true); setStep("code"); }
