...
export function CoordinationDetailClient({ requestId, embedded = false }: { requestId: string; embedded?: boolean }) {
  ...
  return <div className="coordination-detail-page">
    ...
    <div className="coordination-layout">
      <div className="coordination-thread-column">
        ...
        <details open={!embedded} className="portal-panel coordination-thread" aria-labelledby="coordination-thread-title"><summary className="panel-title-row"><div><p className="eyebrow">Permanent work record</p><h2 id="coordination-thread-title">Conversation and activity</h2></div><span>{record.entries.length} entries</span></summary>
