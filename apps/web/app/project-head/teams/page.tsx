...
export default function TeamsPage() {
  ...
  return <>
    ...
    <div className="ph-team-workspace">
      <section className="ph-surface ph-engineer-list"><h2>Engineers ({engineers.length})</h2><input aria-label="Search engineers" type="search" value={search} onChange={(event) => setSearch(event.target.value)} placeholder="Name or email" />
