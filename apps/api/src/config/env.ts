...
const baseEnvSchema = z.object({
  ...
  POTHOLE_AI_URL: z.string().default(""),
  PUBLIC_API_URL: z.string().url().default("http://localhost:4000"),
  POTHOLE_AI_INTERNAL_TOKEN: z.string().default(""),
  POTHOLE_SCAN_PROVIDER: z.enum(["disabled", "demo", "ai"]).default("disabled"),
  POTHOLE_DEMO_ASSET_DIR: z.string().optional(),
  ...
  CLIP_MODE: z.enum(["auto", "hosted", "local_clip", "demo_deterministic"]).default("auto"),
  CLIP_LOCAL_MODEL: z.string().min(1).default("Xenova/clip-vit-base-patch32"),
  CLIP_LOCAL_CACHE_DIR: z.string().min(1).optional(),
